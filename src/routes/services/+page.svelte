  ...
  <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="text-center">
      <h1 class="text-4xl font-serif text-theme-900 sm:text-5xl md:text-6xl">
        ...
        <span class="block text-theme-700">Lactation Support</span>
      </h1>
...
<section class="py-20">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
      <!-- Service List -->
      <div class="space-y-8">
        <div class="bg-white rounded-xl shadow-soft p-8 hover:shadow-lg transition-all duration-300 border border-theme-50">
          <h2 class="text-2xl font-serif text-theme-900 mb-4">Prenatal Preparation</h2>
        ...
        <div class="bg-white rounded-xl shadow-soft p-8 hover:shadow-lg transition-all duration-300 border border-theme-50">
          <h2 class="text-2xl font-serif text-theme-900 mb-4">Essential Techniques</h2>
        ...
        <div class="bg-white rounded-xl shadow-soft p-8 hover:shadow-lg transition-all duration-300 border border-theme-50">
          <h2 class="text-2xl font-serif text-theme-900 mb-4">Advanced Support</h2>
...
<section class="relative py-20">
  ...
  <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="text-center">
      ...
      <div class="mt-10">
        <a href="/insurance" class="inline-flex items-center justify-center px-8 py-4 border-2 border-theme-200 text-lg font-medium rounded-full text-theme-700 bg-white hover:bg-theme-50 transform hover:-translate-y-0.5 transition-all duration-300 shadow-soft hover:shadow-lg">
