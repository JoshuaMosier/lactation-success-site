      ...
      <div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-8 border border-blue-100 hover:shadow-xl transition-shadow duration-300">
          ...
          <div class="text-center mb-8 pb-6 border-b border-blue-100">
            ...
            <h2 class="text-3xl text-blue-900 mb-3 font-serif">Carolyn Mosier</h2>
            <div class="flex items-center justify-center space-x-3 text-blue-700 font-medium text-lg">
              <span>APRN</span>
          ...
          <h2 class="text-2xl font-serif text-gray-900 mb-8 pb-4 border-b border-blue-100">Get in Touch</h2>
          
          <dl class="space-y-8">
            <div>
              <dt class="sr-only">Phone</dt>
              <dd class="flex items-center p-3 hover:bg-blue-50 rounded-lg transition-colors duration-200">
