<script lang="ts">
  // No form data needed for About page
</script>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
      ...
      <div class="space-y-8">
        <div class="bg-white rounded-xl shadow-lg p-8 border border-pink-100">
          <h2 class="text-2xl font-serif text-pink-900 mb-6">Professional Background</h2>
        ...
        <div class="bg-white rounded-xl shadow-lg p-8 border border-pink-100">
          <h2 class="text-2xl font-serif text-pink-900 mb-6">My Approach</h2>
        ...
        <div class="bg-white rounded-xl shadow-lg p-8 border border-pink-100">
          <h2 class="text-2xl font-serif text-pink-900 mb-6">Personal Experience</h2>
          <p class="text-gray-600">
      ...
      <div>
        <!-- Contact Information -->
        <div class="bg-white rounded-xl shadow-lg p-8 border border-pink-100 hover:shadow-xl transition-shadow duration-300">
          <!-- Profile Section -->
          <div class="text-center mb-8 pb-6 border-b border-pink-100">
            ...
            <h2 class="text-3xl text-pink-900 mb-3 font-serif">Carolyn Mosier</h2>
            <div class="flex items-center justify-center space-x-3 text-pink-700 font-medium text-lg">
              <span>APRN</span>
          ...
          <h2 class="text-2xl font-serif text-gray-900 mb-8 pb-4 border-b border-pink-100">Get in Touch</h2>
          
          <dl class="space-y-8">
            <div>
              <dt class="sr-only">Phone</dt>
              <dd class="flex items-center p-3 hover:bg-pink-50 rounded-lg transition-colors duration-200">
