...
<svelte:head>
  ...
  <meta name="description" content="Schedule a lactation consultation with Carolyn Mosier APRN, IBCLC. Offering in-home visits and telehealth appointments in Northern Virginia." />
            ...
            <div class="sm:ml-4 w-full">
              ...
              <div class="mt-8 pt-6 border-t border-gray-200">
                <div class="text-gray-600 text-sm space-y-1">
                  ...
                  <p>• Payment accepted via Cash, Venmo, or credit card prior to your appointment</p>
                </div>
              </div>
            </div>
          </div>
